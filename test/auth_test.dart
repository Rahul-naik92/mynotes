    ...
    () {
      ...
      test('Cannot log out if not initialized ', () {
        expect(
          provider.logOut(),
          throwsA(
            const TypeMatcher<NotIntitializedException>(),
          ),
        );
      });
...
class NotIntitializedException implements Exception {}

class MockAuthProvider implements AuthProvider {
  AuthUser? _user;
  var _isInitalized = false;
  bool get isIntialized => _isInitalized;
  ...
  Future<AuthUser?> createUser({
    ...
    if (!isIntialized) throw NotIntitializedException();
